...
const Aside = () => {
  ...
  return (
    <aside id="aside_nav">
      <nav>
        <ul>
          <li><NavHashLink to="/portfolio/#home" data-danish="Hjem" data-english="Home" onPointerEnter={glitchText}>{isDanish ? "Hjem" : "Home"}</NavHashLink></li>
          <li><NavHashLink to="/portfolio/#about" data-danish="Om mig" data-english="About" onPointerEnter={glitchText}>{isDanish ? "Om mig" : "About"}</NavHashLink></li>
          <li><NavHashLink to="/portfolio/#projects" data-danish="Projekter" data-english="Projects" onPointerEnter={glitchText}>{isDanish ? "Projekter" : "Projects"}</NavHashLink></li>
        </ul>
